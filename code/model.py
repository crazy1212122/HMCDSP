...
class GCN_drug(nn.Module):
    def __init__(self, args):
        ...
        self.gat_drug1_f = GATConv(self.args.fdrug, self.args.fdrug,heads=3,concat=False, edge_dim=1)
        ...
        self.gat_cir1_f = GATConv(self.args.fcir, self.args.fcir,heads=1,concat=False, edge_dim=1)
    ...
    def forward(self,data):
        ...
        return cir_fea.mm(drug_fea.t()),drug_fea, cir_fea
